...
def add_batch_process(conn_string, lim, bsize):
...
p = Pool(num_proc)
multiple_results = [p.apply_async(add_batch_process, (conn_string, num_records, batch_size,)) for i in range(num_proc)]
